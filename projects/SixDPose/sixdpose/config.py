...
def add_sixdpose_config(cfg):
    ...
    _C.MODEL.ROI_HCR_HEAD.NUM_STACKED_CONVS = 2   # densepose is 8
    _C.MODEL.ROI_HCR_HEAD.CONV_HEAD_DIM = 128     # densepose is 512
    _C.MODEL.ROI_HCR_HEAD.NORM = ""
    _C.MODEL.ROI_HCR_HEAD.CLS_AGNOSTIC_KEYPOINT = False
    _C.MODEL.ROI_HCR_HEAD.NUM_KEYPOINTS = 9
    ...
    # # Loss weights for VERTEX
    _C.MODEL.ROI_HCR_HEAD.OFFSET_WEIGHTS = 1.0
