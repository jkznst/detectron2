        ...
        for task in sorted(tasks):
            coco_eval = (
                _evaluate_predictions_on_coco(
                    self._coco_api, self._coco_results, task, kpt_oks_sigmas=self._kpt_oks_sigmas, kpt_format=self._kpt_format
                )
...
def _evaluate_predictions_on_coco(coco_gt, coco_results, iou_type, kpt_oks_sigmas=None, kpt_format='bb8+fps8'):
    """
    ...
    coco_eval = COCOeval(coco_gt, coco_dt, iou_type, kpt_format)
